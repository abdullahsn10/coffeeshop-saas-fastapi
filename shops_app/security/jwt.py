...
#     """
#     try:
#         payload = jwt.decode(token, settings.JWT_TOKEN_SETTINGS["PUBLIC_KEY"],
#                              algorithms=settings.JWT_TOKEN_SETTINGS["ALGORITHM"])
...
#         except ValueError:
#             raise credentials_exception
#         token_data = schemas.TokenData(email=email, role=role_enum, id=id)
#         return token_data
